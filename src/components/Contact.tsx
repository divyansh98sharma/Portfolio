          ...
          <div className="text-center space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-3xl mx-auto">
              ...
              <Button
                asChild
                size="lg"
                className="h-14 w-full hover:bg-primary/90 active:bg-primary/80 focus-visible:ring-4 focus-visible:ring-ring/20 transition-all duration-200 sm:col-span-2 lg:col-span-1"
              >
              ...
              {/* LinkedIn - with LinkedIn blue hover */}
              <Button
                asChild
                size="lg"
                variant="outline"
                className="h-14 w-full border-2 hover:bg-[#0A66C2]/10 hover:border-[#0A66C2]/30 hover:text-[#0A66C2] dark:hover:bg-[#0A66C2]/20 dark:hover:text-[#5BA3E6] active:bg-[#0A66C2]/20 focus-visible:ring-4 focus-visible:ring-ring/20 transition-all duration-200"
              >
                <a href="https://www.linkedin.com/in/divyansh98sharma" target="_blank" rel="noopener noreferrer" aria-label="Visit LinkedIn profile">
                  <svg className="h-5 w-5 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor">
              ...
              {/* Medium - with Medium green/dark hover */}
              <Button
                asChild
                size="lg"
                variant="outline"
                className="h-14 w-full border-2 hover:bg-[#1a8917]/10 hover:border-[#1a8917]/30 hover:text-[#1a8917] dark:hover:bg-[#1a8917]/20 dark:hover:text-[#4ade80] active:bg-[#1a8917]/20 focus-visible:ring-4 focus-visible:ring-ring/20 transition-all duration-200"
              >
                <a href="https://medium.com/@divyansh98sharma" target="_blank" rel="noopener noreferrer" aria-label="Visit Medium profile">
                  <svg className="h-5 w-5 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1043.63 592.71" fill="currentColor">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-14 w-full border-2 hover:bg-accent hover:border-accent-foreground/20 active:bg-accent/80 focus-visible:ring-4 focus-visible:ring-ring/20 transition-all duration-200"
              >
                <a href="https://www.interaction-design.org/members/divyansh-sharma-2?r=divyansh-sharma-2" target="_blank" rel="noopener noreferrer" aria-label="Visit IxDF profile">
                  <svg className="h-5 w-5 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="currentColor">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-14 w-full border-2 hover:bg-accent hover:border-accent-foreground/20 active:bg-accent/80 focus-visible:ring-4 focus-visible:ring-ring/20 transition-all duration-200 sm:col-span-2 lg:col-span-1"
              >
                <a href="https://drive.google.com/uc?export=download&id=1iKns9fXX71B5UERPHJofvvYRuz6mqkp8" target="_blank" rel="noopener noreferrer" aria-label="Download my resume as PDF">
                  <Download className="h-5 w-5 mr-2 flex-shrink-0" aria-hidden="true" />
                  Resume
                </a>
              </Button>
            </div>
