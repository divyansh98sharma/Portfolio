        ...
        <div className="max-w-6xl mx-auto">
          <div className={`mb-16 transition-all duration-700 ${
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-sm font-semibold text-muted-foreground uppercase tracking-wider" style={{ fontFamily: "'Silkscreen', sans-serif" }}>
                Case Studies
              </p>
            </div>
            <h2
              ...
              style={{ fontFamily: "'Silkscreen', sans-serif", fontWeight: 800, fontSize: 'clamp(2rem, calc(4vw * var(--canvas-zoom, 1)), 3.2rem)' }}
            >
              Featured{' '}
