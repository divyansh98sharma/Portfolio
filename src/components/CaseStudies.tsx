...
export function CaseStudies() {
  ...
  const handleKeyDown = (event: React.KeyboardEvent, studyId: Page) => {
    ...
    >
      <div className="container mx-auto">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8" role="list" aria-label="Design case studies">
