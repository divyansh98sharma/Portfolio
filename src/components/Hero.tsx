        ...
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10">
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="inline-block py-2">
                <h1 className="text-xl sm:text-2xl md:text-3xl text-muted-foreground mb-2 tracking-wide">
                  Hi, I'm
                </h1>
                <h2 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-medium bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent leading-tight pb-2 sm:pb-3">
                  Divyansh Sharma
                </h2>
              </div>
              
              <div className="relative">
                <h3 id="hero-heading" className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl text-muted-foreground/90 mb-6 sm:mb-8 min-h-[3rem] sm:min-h-[4rem] md:min-h-[5rem]">
                  <TypewriterText 
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center pt-4 px-4 sm:px-0">
            <Button 
              ...
              size="lg"
              className="w-full sm:w-auto min-w-[164px] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            ...
            <Button 
              ...
              size="lg"
              className="w-full sm:w-auto min-w-[164px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105"
          ...
          <div className="flex justify-center pt-24 sm:pt-32 animate-bounce">
            <Button 
              variant="ghost" 
              size="icon"
